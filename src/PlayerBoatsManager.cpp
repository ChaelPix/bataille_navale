...
{
	boatsType.push_back(BattleshipCore::boatTypes::ContreTorpilleur);
	boatsType.push_back(BattleshipCore::boatTypes::Croiseur);
	boatsType.push_back(BattleshipCore::boatTypes::Croiseur);
	boatsType.push_back(BattleshipCore::boatTypes::PorteAvion);
	boatsType.push_back(BattleshipCore::boatTypes::Torpilleur);
...
int PlayerBoatsManager::getTextureIndex(BattleshipCore::boatTypes type)
{
	int textureIndex;
	switch (type)
	{
	case BattleshipCore::boatTypes::PorteAvion:
		textureIndex = 0;
		break;
	case BattleshipCore::boatTypes::Croiseur:
		textureIndex = 1;
		break;
	case  BattleshipCore::boatTypes::ContreTorpilleur:
		textureIndex = 2;
		break;
	case  BattleshipCore::boatTypes::Torpilleur:
		textureIndex = 3;
		break;
	default:
		textureIndex = 0;
